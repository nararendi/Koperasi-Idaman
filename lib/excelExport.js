...
export const excelExport = {
  ...
  exportLaporanKeuangan(laporan, settings, labelPeriode) {
    ...
    const content = `
      <table>
        <tr>
          <td colspan="5" class="kop-title">${(settings.namaKoperasi || 'KOPERASI SIMPAN PINJAM IDAMAN').toUpperCase()}</td>
        </tr>
        <tr>
          <td colspan="5" class="kop-sub">${settings.badanHukum || 'Badan Hukum: AHU-0012948.AH.01.26.TAHUN 2020'} &bull; ${settings.alamat || 'Jakarta, Indonesia'} &bull; Telp: ${settings.telepon || '-'}</td>
        </tr>
        <tr>
      ...
      <table class="ttd-table">
        ...
        <tr>
          <td colspan="2"><u>${settings.ketua || 'Drs. H. M. Supriyadi, M.M.'}</u></td>
          <td colspan="3"><u>${settings.bendahara || 'Ratna Kusuma, S.E.'}</u></td>
        </tr>
      </table>
    `;
  ...
  exportBukuKas(kasList, summary, settings) {
    ...
    const content = `
      <table>
        <tr>
          <td colspan="8" class="kop-title">${(settings.namaKoperasi || 'KOPERASI SIMPAN PINJAM IDAMAN').toUpperCase()}</td>
        </tr>
        <tr>
          <td colspan="8" class="kop-sub">${settings.alamat || 'Jakarta, Indonesia'} &bull; Telp: ${settings.telepon || '-'}</td>
        </tr>
        <tr>
      ...
      <table class="ttd-table">
        ...
        <tr>
          <td colspan="4"><u>${settings.ketua || 'Drs. H. M. Supriyadi, M.M.'}</u></td>
          <td colspan="4"><u>${settings.bendahara || 'Ratna Kusuma, S.E.'}</u></td>
        </tr>
      </table>
    `;
  ...
  exportAnggota(anggotaList, settings) {
    ...
    const content = `
      <table>
        <tr>
          <td colspan="9" class="kop-title">${(settings.namaKoperasi || 'KOPERASI SIMPAN PINJAM IDAMAN').toUpperCase()}</td>
        </tr>
        <tr>
  ...
  exportSimpanan(simpananList, summary, settings) {
    ...
    const content = `
      <table>
        <tr>
          <td colspan="10" class="kop-title">${(settings.namaKoperasi || 'KOPERASI SIMPAN PINJAM IDAMAN').toUpperCase()}</td>
        </tr>
        <tr>
  ...
  exportPinjaman(pinjamanList, summary, settings) {
    ...
    const content = `
      <table>
        <tr>
          <td colspan="11" class="kop-title">${(settings.namaKoperasi || 'KOPERASI SIMPAN PINJAM IDAMAN').toUpperCase()}</td>
        </tr>
        <tr>
