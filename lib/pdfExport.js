...
export const pdfExport = {
  ...
  exportDaftarTagihanPDF(tagihanData, settings, labelPeriode) {
    ...
    const html = `
      ...
      <!-- Tanda Tangan Resmi Simetris & Sejajar -->
      <div style="margin-top: 30px; width: 100%;">
        <table style="width: 100%; border: none; font-size: 9.5pt; line-height: 1.3;">
          <tr>
            <td style="width: 50%; vertical-align: top; text-align: left; padding-left: 20px;">
              <div style="visibility: hidden; margin-bottom: 2px;">${dateLine}</div>
              <div>Ketua Koperasi</div>
              <div style="height: 55px;"></div>
              <div><strong style="text-decoration: underline; font-size: 10pt;">${settings.ketua || 'Asep Solehudin, S.Pd.'}</strong></div>
            </td>
            <td style="width: 50%; vertical-align: top; text-align: left; padding-left: 40px;">
              <div style="margin-bottom: 2px;">${dateLine}</div>
              <div>Bendahara Koperasi</div>
              <div style="height: 55px;"></div>
              <div><strong style="text-decoration: underline; font-size: 10pt;">${settings.bendahara || 'Ica Cahyani'}</strong></div>
            </td>
          </tr>
        </table>
      </div>
