  ...
  exportLaporanKeuanganPDF(laporan, settings, labelPeriode) {
    ...
    const html = `
      <div class="kop-container">
        <div class="kop-title">${settings.namaKoperasi || 'Koperasi Simpan Pinjam Idaman'}</div>
        <div class="kop-sub">${settings.badanHukum || 'Badan Hukum: AHU-0012948.AH.01.26.TAHUN 2020'}</div>
        <div class="kop-sub">${settings.alamat || 'Jl. Jenderal Sudirman No. 45, Jakarta Pusat'} &bull; Telp: ${settings.telepon || '(021) 5798-2345'} &bull; Email: ${settings.email || 'info@koperasi-idaman.co.id'}</div>
      </div>
      ...
      <div class="ttd-container">
        <table class="ttd-table">
          <tr>
            ...
            <td style="width: 50%;">Jakarta, ${todayStr}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><u><strong>${settings.ketua || 'Drs. H. M. Supriyadi, M.M.'}</strong></u></td>
            <td><u><strong>${settings.bendahara || 'Ratna Kusuma, S.E.'}</strong></u></td>
          </tr>
        </table>
      </div>
    `;
    ...
    const html = `
      <div class="kuitansi-box">
        <div class="kop-container" style="border-bottom: 2px solid #000; margin-bottom: 10px;">
          <div class="kop-title" style="font-size: 14pt;">${settings.namaKoperasi || 'KOPERASI SIMPAN PINJAM IDAMAN'}</div>
          <div class="kop-sub">${settings.alamat || 'Jakarta, Indonesia'} &bull; Telp: ${settings.telepon || '(021) 5798-2345'}</div>
        </div>
