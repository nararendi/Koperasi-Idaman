...
export const authService = {
  ...
  getCurrentUser() {
    ...
    try {
      ...
      if (!raw) {
        // Default login as Super Admin for smooth initial access
        localStorage.setItem(AUTH_STORAGE_KEY, JSON.stringify(defaultUsers[0]));
  ...
  updateUser(id, updatedFields) {
    ...
    // If updated user is current user, update session
